...
/*import React, { useState, useContext } from "react"; //imp cod
  ...
  const getCartItemsList = () => {
    return food_list
      ...
      .map((item) => ({
        ...
        // ✅ Your backend requires these also inside items[]
        firstName: deliveryInfo.firstName,
        phone: deliveryInfo.phone,
        street: deliveryInfo.street,
        city: deliveryInfo.city,
        linkdata: deliveryInfo.linkdata,
